...
function M.setup()
    ...
    local show_open_folds = vim.g.custom_statuscolumn and vim.g.custom_statuscolumn.folds_open
    local use_githl = vim.g.custom_statuscolumn and vim.g.custom_statuscolumn.folds_githl
